...
rate_interval = 200     # bin size to compute firing rate
...
@network_operation(dt=rate_interval*ms)
def compute_inh_firing_rate(t):
    ...
    if t == 0:
        ...
        return
    firing_rate = get_n_of_spikes(spike_times, t, rate_interval)/     \
                  (rate_interval / 1000 * NI)
